...
/**
 * Created by MAITRI SHAH on 04/04/2017.
 */
public class SuggestionBoxFinal extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        textArea.setOnKeyPressed(event -> {
            ...
            if(rowCount>16)
                ...
                listView.setTranslateY(80+ (rowCount * charHeight));

            if (event.getText().matches("\\w+") || event.getCode().equals(KeyCode.COMMA)){
                tempAddition=0;
                term+=event.getText();
